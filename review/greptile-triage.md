...
Read `~/.kstack/greptile-history.md` if it exists. Each line records a previous triage outcome:
...
Append one line per triage outcome to `~/.kstack/greptile-history.md`:
```
...
Example entries:
```
2026-03-13 | kadenn/myapp | fp | app/services/auth_service.rb | race-condition
2026-03-13 | kadenn/myapp | fix | app/models/user.rb | null-check
2026-03-13 | kadenn/myapp | already-fixed | lib/payments.rb | error-handling
```
