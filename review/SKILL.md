...
2. **FALSE POSITIVE comments:** Present each one via AskUserQuestion:
   ...
   If the user chooses A, post a reply using the appropriate API from the triage doc and save the pattern to `~/.kstack/greptile-history.md` (type: fp).
